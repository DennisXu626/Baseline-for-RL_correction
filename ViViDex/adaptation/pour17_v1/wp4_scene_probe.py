"""WP4 two-slot reset/hold readback. Approved root overlay; no training or reference solve.
...
def main():
    ...
    try:
        ...
        save("result.json",dict(status="COMPLETED_WP4_RESET_HOLD_NOT_PHYSICS_PASS",num_envs=2,
